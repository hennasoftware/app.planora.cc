  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 container mx-auto flex h-full max-w-4xl flex-col items-center justify-center px-4 text-center text-white">
        <i className="fa-regular fa-compass text-6xl opacity-90"></i>

        <h1 className="mt-10 text-2xl leading-snug font-semibold transition-opacity duration-300 md:text-4xl">
          Este roteiro não está mais disponível
        </h1>

        <h2 className="mt-4 text-white/90 md:text-xl">Não encontramos um roteiro ativo com este endereço</h2>

        <div className="mx-auto my-8 h-px w-12 bg-white opacity-50" />

        <p className="text-sm leading-relaxed text-white/70 md:text-base">
          O link pode estar incompleto ou a viagem pode ter sido encerrada após o período de disponibilidade
        </p>
      </div>
    </section>
  );
